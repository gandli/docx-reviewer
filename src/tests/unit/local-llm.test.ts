...
describe("local llm", () => {
  ...
  it("accepts openai-compatible responses whose message content is a single object", async () => {
    vi.spyOn(globalThis, "fetch").mockResolvedValueOnce({
      ok: true,
      json: async () => ({
        choices: [
  ...
  it("accepts openai-compatible responses whose message content nests text deeper in the object", async () => {
    vi.spyOn(globalThis, "fetch").mockResolvedValueOnce({
      ok: true,
      json: async () => ({
        choices: [
